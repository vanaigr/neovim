...
func Test_linebreak_with_breakindent()
  call s:test_windows('setl ts=4 breakindent briopt=min:14 list listchars=tab:>-,space:.')
  call setline(1, "\t abcdefghijklmnopqrstuvwxyz" ..
        \ "abcdefghijklmnopqrstuvwxyz")
  let lines = s:screen_lines([1, 4], winwidth(0))
  let expect = [
...
\ "     tuvwxyz        "]
  ...
  call s:test_windows('setl ts=4 breakindent briopt=min:15 list listchars=tab:>-,space:.')
  call setline(1, "\t abcdefghijklmnopqrstuvwxyz" ..
        \ "abcdefghijklmnopqrstuvwxyz")
  let lines = s:screen_lines([1, 4], winwidth(0))
  let expect = [
...
\ "     tuvwxyz        "]
  ...
  call s:test_windows('setl ts=4 breakindent briopt=min:16 list listchars=tab:>-,space:.')
  call setline(1, "\t abcdefghijklmnopqrstuvwxyz" ..
        \ "abcdefghijklmnopqrstuvwxyz")
  let lines = s:screen_lines([1, 4], winwidth(0))
  let expect = [
...
func Test_linebreak_with_showbreak()
  call s:test_windows('setl ts=4 linebreak showbreak=123456 wrap list listchars=space:.')
  call setline(1, "!@#$ abcdefghijklmnopqrstuvwxyz" ..
        \ "abcdefghijklmnopqrstuvwxyz")
  let lines = s:screen_lines([1, 4], winwidth(0))
  let expect = [
...
\ '123456rstuvwxyz     ']
  ...
  call s:test_windows('setl ts=4 linebreak showbreak=12345 wrap list listchars=space:.')
  call setline(1, "!@#$ abcdefghijklmnopqrstuvwxyz" ..
        \ "abcdefghijklmnopqrstuvwxyz")
  let lines = s:screen_lines([1, 4], winwidth(0))
  let expect = [
...
\ '12345tuvwxyz        ']
  ...
  call s:test_windows('setl ts=4 linebreak showbreak=1234 wrap list listchars=space:.')
  call setline(1, "!@#$ abcdefghijklmnopqrstuvwxyz" ..
        \ "abcdefghijklmnopqrstuvwxyz")
  let lines = s:screen_lines([1, 4], winwidth(0))
  let expect = [
